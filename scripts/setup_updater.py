#!/usr/bin/env python3
"""
Universal Auto-Updater Setup Script v1.1
...
- Cross-platform launcher logic (Windows/macOS/Linux)
...
class UpdateChecker:
    ...
    def _fetch_url(self, url: str) -> str:
        req = urllib.request.Request(url, headers={{"User-Agent": "{app_name}-Updater/1.0"}})
    ...
    def download(self, update_info: UpdateInfo) -> None:
        ...
        try:
            ...
            req = urllib.request.Request(
                ...
                headers={{"User-Agent": "{app_name}-Updater/1.0"}}
            )
...
class UpdateManager(QObject):
    ...
    def launch_installer(self, filepath: str) -> bool:
        """Launch the installer executable (Cross-platform)."""
        try:
