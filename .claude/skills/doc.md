...
> **Hướng dẫn tạo và sử dụng Skills trong framework AI agentów**

---

## 📋 Giới thiệu

Mặc dù modele AI są potężnymi narzędziami ogólnego przeznaczenia, nie znają kontekstu konkretnego projektu ani standardów twojego zespołu. Ładowanie każdej reguły lub narzędzia do okna kontekstu agenta prowadzi do "rozdęcia narzędzi", wyższych kosztów, opóźnień i zamieszania.

**Skills** rozwiązują ten problem poprzez **Progressive Disclosure**. Skill to wyspecjalizowany pakiet wiedzy, który pozostaje nieaktywny do momentu, gdy jest potrzebny. Informacje są ładowane do kontekstu agenta tylko wtedy, gdy konkretne zapytanie pasuje do opisu skill'a.
