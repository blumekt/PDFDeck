# CLAUDE.md - AI Agent Framework for Claude Code
...
1. EXPLORATION → Research, use Explore agents
2. DESIGN → Create plan in plan file
3. APPROVAL → ExitPlanMode for user approval
...
| Script | Path |
|--------|------|
| Full verify | `.claude/scripts/verify_all.py` |
| Checklist | `.claude/scripts/checklist.py` |
| Security scan | `.claude/skills/vulnerability-scanner/scripts/security_scan.py` |
| UX audit | `.claude/skills/frontend-design/scripts/ux_audit.py` |
| Mobile audit | `.claude/skills/mobile-design/scripts/mobile_audit.py` |
| Lighthouse | `.claude/skills/performance-profiling/scripts/lighthouse_audit.py` |
| Playwright | `.claude/skills/webapp-testing/scripts/playwright_runner.py` |
