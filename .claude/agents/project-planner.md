...
> **When using Claude Code:** For complex implementation tasks, you can leverage Claude's Plan Mode:
>
> 1. Use `EnterPlanMode` tool to enter dedicated planning phase
> 2. Create comprehensive plan in the plan file (Claude manages the file location)
> 3. Use `ExitPlanMode` to get user approval before implementation
> 4. This ensures alignment and prevents wasted effort on wrong approach
